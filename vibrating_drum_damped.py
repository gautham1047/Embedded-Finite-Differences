...
print("="*70)
print("VIBRATING DRUM WITH DAMPING")
print("="*70)
...
gamma = 0.2          # Damping coefficient (try 0.0, 0.1, 0.2, 0.5)
drum_radius = 1.0    # Drum radius

print(f"\nPhysical Parameters:")
print(f"  Wave speed c: {np.sqrt(c_squared):.2f}")
print(f"  Damping coefficient gamma: {gamma:.2f}")
...
print(f"\nSolving damped wave equation with Newmark-beta method...")
...
fig.suptitle(f'Vibrating Drum with Damping (γ={gamma})', fontsize=16)
